...
//		}
	...
	public static void delorder(WebDriver driver,OrderInfo oinfo){
		driver.findElement(By.id("appendedInputButton")).clear();
		driver.findElement(By.id("appendedInputButton")).sendKeys(oinfo.getOrname());
		driver.findElement(By.xpath("//*[@id='queryForm']/button")).click();
		driver.findElement(By.className("dele-icon")).click();
		driver.findElement(By.className("confirm")).click();
	}
	
	public static void datacheck(OrderInfo oinfo) throws SQLException{
		String sql = "select removed from ad_order where name = '"+oinfo.getOrname()+"'";
		DBService.databasecheck(sql,oinfo.getOrname()+"删除失败" );
	}
