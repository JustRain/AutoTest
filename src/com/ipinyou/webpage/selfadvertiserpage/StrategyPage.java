...
public class StrategyPage {
	...
	public static void createstrategy(WebDriver driver,StrategyInfo sinfo) throws InterruptedException,NoSuchElementException,AssertionError,ElementNotVisibleException{
		...
		boolean crowdflag = PubHandle.doesWebElementExist(driver, By.id("btn-baiduAudiences"));
		if(crowdflag){
			//百度人群设定
...
//		driver.findElement(By.id("cpm")).sendKeys(sinfo.getCpmprice());
//		driver.findElement(By.id("imps")).sendKeys(sinfo.getDailyimps());
//		PubHandle.select(driver, By.id("effectGoal"), "未设置");
