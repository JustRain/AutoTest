...
public class BatchClosePosition {
	WebDriver driver;
  ...
  public void login(String loginname,String password) {
	...
	public void batchclose() throws InterruptedException{
		...
		selall.click();
		WebElement batchclose = driver.findElement(By.xpath("/html/body/div[3]/div/div/div[3]/div[2]/a"));
		batchclose.click();
		Thread.sleep(1000);
		WebElement close = driver.findElement(By.linkText("批量关闭"));
		close.click();
		Thread.sleep(1000);
	...
	public void check(){
		...
		assertEquals("批量开启失败",status1.getText(),"关闭");
		...
		if(!status2.getText().equals("关闭")){
			s.taskScreenShot(driver);
			assertEquals("批量开启失败",status2.getText(),"关闭");
		}
